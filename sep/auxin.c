...
_XFUNCPROTOBEGIN
FILE *auxin(const char *name) _XFUNCPROTOEND
#else
FILE *auxin(name) char *name;
#endif
{
  streaminf *info;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
int fauxin(const char *name) _XFUNCPROTOEND
#else
int fauxin(name) char *name;
#endif
{
  if (auxin(name) == NULL)
    return -1;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
FILE *auxout(const char *name) _XFUNCPROTOEND
#else
FILE *auxout(name) char *name;
#endif
{
  streaminf *info;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
FILE *auxinout(const char *name) _XFUNCPROTOEND
#else
FILE *auxinout(name) char *name;
#endif
{
  streaminf *info;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
FILE *auxsockout(const char *name) _XFUNCPROTOEND
#else
FILE *auxsockout(name) char *name;
#endif
{
  streaminf *info;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
FILE *auxscr(const char *name) _XFUNCPROTOEND
#else
FILE *auxscr(name) char *name;
#endif
{
  streaminf *info;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
FILE *auxtmp(const char *name) _XFUNCPROTOEND
#else
FILE *auxtmp(name) char *name;
#endif
{
  streaminf *info;
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
int aux_unlink(const char *name) _XFUNCPROTOEND
#else
int aux_unlink(name) char *name;
#endif
{
  streaminf *info;
  char *all_names, *one_name, *exp_name;
  ...
  all_names =
      strcpy((char *)malloc(strlen(info->dataname) + 1), info->dataname);
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
int copy_history(const char *from, const char *to) _XFUNCPROTOEND
#else
int copy_history(from, to) char *from, *to;
#endif
{
...
#if NeedFunctionPrototypes
_XFUNCPROTOBEGIN
int tag_exists(const char *tag) _XFUNCPROTOEND
#endif
{
  streaminf *info;
  int i;
